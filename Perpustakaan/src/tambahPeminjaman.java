...
public class tambahPeminjaman extends javax.swing.JDialog {
    ...
    public tambahPeminjaman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        save.setBackground(new java.awt.Color(120, 192, 205));
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, bodyLayout.createSequentialGroup()
                ...
                .addGroup(bodyLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(bodyLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, bodyLayout.createSequentialGroup()
                        .addComponent(save_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(139, 139, 139))))
        );
    ...
    private void save() {
        ...
        if (empty(getid_anggota) || empty(getkode) || empty(gettanggal)) {
            JOptionPane.showMessageDialog(null, "Data yang Anda masukkan belum lengkap!", "Peringatan!", JOptionPane.WARNING_MESSAGE);
        } else {
            try {
                Connection con = new database.dbconnection().configDB();
                String get = "SELECT * FROM peminjaman WHERE id_anggota = '"+getid_anggota+"' AND kode = '"+getkode+"'";
                java.sql.Statement st = con.createStatement();
