...
public class home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        title.setToolTipText("Perpustakaan");
        ...
        search_anggota.setToolTipText("Cari Data");
        ...
        if (baris >= 0) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    new edit_peminjaman(this, rootPaneCheckingEnabled, id_anggota).setVisible(true);
                }
            } catch (Exception e) {
...
private void tampil_peminjaman() {
    ...
    private void search_peminjaman() {
        ...
        try {
            Connection con = new database.dbconnection().configDB();
            String sql = "SELECT * FROM peminjaman id_peminjaman WHERE BINARY "
