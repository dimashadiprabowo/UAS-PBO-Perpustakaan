...
public class edit_peminjaman extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tbl_buku.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kode Buku", "Judul Buku", "Tanggal Input"
            }
        ));
    ...
    private void tampil_buku() {
        Object []baris = {"Kode Buku", "Judul Buku", "Tanggal Input"};
    ...
    private void save() {
        ...
        if (!empty(gettanggal)) {
            try {
                Connection con = new database.dbconnection().configDB();
                String sql = "UPDATE peminjaman SET id_anggota = ?, nama = ?, kode = ?, judul = ?, tanggal = ? WHERE id_peminjaman = '"+id+"'";
