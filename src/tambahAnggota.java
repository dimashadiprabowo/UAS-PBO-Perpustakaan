...
public class tambahAnggota extends javax.swing.JDialog {
    ...
    public tambahAnggota(java.awt.Frame parent, boolean modal) {
        ...
        // Mouse listener untuk drag window
        ...
        // Document filter untuk ID anggota (hanya angka)
            ...
            try {
                ...
                if (id < 1 || id > 2147483647) {
                    ...
                    try {
                        ...
                        // Tutup semua resource database untuk mencegah memory leak
                        try {
    ...
    // Method helper untuk mengecek string kosong
